...
export interface ApiAdvertisementAdvertisement
  ...
  attributes: {
    ...
    position: Schema.Attribute.Enumeration<
      ['top-banner', 'header', 'homepage', 'article', 'sidebar', 'footer']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiEPaperEPaper extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    editionDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    featuredArticles: Schema.Attribute.Relation<
      ...
      'api::article.article'
    >;
    featuredGallery: Schema.Attribute.Relation<
      'oneToMany',
      'api::advertisement.advertisement'
    >;
    featuredVideos: Schema.Attribute.Relation<
      'oneToMany',
      'api::advertisement.advertisement'
    >;
    ...
    heroArticles: Schema.Attribute.Relation<
      'oneToMany',
      'api::article.article'
    >;
    locale: Schema.Attribute.String;
